...
print ("Searching for a Donation to " + lukewearechange)
...
if btcdonation != "0.00000000" :
        txt1 = "#bitcoin #donation @Lukewearechange " + btcdonation + " BTC #thankyou #WeAreChange"
        s = twitter.update_status(status=txt1)
        print (s)
os.system('python /home/pi/preservingHirosaki.py')
